...
const TradeFederation = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="TradeFederation-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 496 512',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-TradeFederation',
      focusable: 'false',
...
TradeFederation.defaultProps = { height: undefined, width: undefined}
