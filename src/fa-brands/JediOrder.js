...
const JediOrder = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="JediOrder-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 448 512',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-JediOrder',
      focusable: 'false',
...
JediOrder.defaultProps = { height: undefined, width: undefined}
