...
const LINEWEBTOON = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="LINEWEBTOON-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-LINEWEBTOON',
      focusable: 'false',
...
LINEWEBTOON.defaultProps = { height: 24, width: 24}

export default LINEWEBTOON
