...
const Coursera = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="Coursera-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-Coursera',
      focusable: 'false',
...
Coursera.defaultProps = { height: 24, width: 24}
