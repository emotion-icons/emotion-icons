...
const DiceFive = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="DiceFive-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 448 512',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-DiceFive',
      focusable: 'false',
...
DiceFive.defaultProps = { height: undefined, width: undefined}
