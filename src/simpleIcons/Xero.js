...
export const hex='#13B5EA'
const Xero = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="Xero-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-Xero',
      focusable: 'false',
...
Xero.defaultProps = { height: 24, width: 24}
