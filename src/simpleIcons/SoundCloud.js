...
const SoundCloud = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="SoundCloud-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-SoundCloud',
      focusable: 'false',
...
SoundCloud.defaultProps = { height: 24, width: 24}
