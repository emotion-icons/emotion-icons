...
const DiceTwo = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="DiceTwo-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 448 512',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-DiceTwo',
      focusable: 'false',
...
DiceTwo.defaultProps = { height: undefined, width: undefined}
