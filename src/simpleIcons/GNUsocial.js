...
const GNUsocial = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="GNUsocial-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-GNUsocial',
      focusable: 'false',
...
GNUsocial.defaultProps = { height: 24, width: 24}
