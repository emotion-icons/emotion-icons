...
const Runkeeper = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="Runkeeper-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-Runkeeper',
      focusable: 'false',
...
Runkeeper.defaultProps = { height: 24, width: 24}
