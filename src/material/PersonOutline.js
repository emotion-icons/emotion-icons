...
const PersonOutline = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="PersonOutline-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-PersonOutline',
      focusable: 'false',
...
PersonOutline.defaultProps = { height: 24, width: 24}
