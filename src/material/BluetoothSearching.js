...
const BluetoothSearching = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="BluetoothSearching-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-BluetoothSearching',
      focusable: 'false',
...
BluetoothSearching.defaultProps = { height: 24, width: 24}
