...
const AmericanExpress = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="AmericanExpress-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-AmericanExpress',
      focusable: 'false',
...
AmericanExpress.defaultProps = { height: 24, width: 24}
