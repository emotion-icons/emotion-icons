...
const SignalWifi3Bar = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="SignalWifi3Bar-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-SignalWifi3Bar',
      focusable: 'false',
...
SignalWifi3Bar.defaultProps = { height: 24, width: 24}
