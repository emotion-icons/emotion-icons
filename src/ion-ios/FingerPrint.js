...
const FingerPrint = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="FingerPrint-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 512 512',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-FingerPrint',
      focusable: 'false',
...
FingerPrint.defaultProps = { height: undefined, width: undefined}
