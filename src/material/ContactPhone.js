...
const ContactPhone = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="ContactPhone-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-ContactPhone',
      focusable: 'false',
...
ContactPhone.defaultProps = { height: 24, width: 24}
