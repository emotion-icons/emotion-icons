...
const MediaTemple = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="MediaTemple-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-MediaTemple',
      focusable: 'false',
...
MediaTemple.defaultProps = { height: 24, width: 24}
