...
const PhoenixSquadron = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="PhoenixSquadron-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 513 512',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-PhoenixSquadron',
      focusable: 'false',
...
PhoenixSquadron.defaultProps = { height: undefined, width: undefined}
