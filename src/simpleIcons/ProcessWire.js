...
const ProcessWire = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="ProcessWire-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-ProcessWire',
      focusable: 'false',
...
ProcessWire.defaultProps = { height: 24, width: 24}
