...
const GoogleChrome = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="GoogleChrome-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-GoogleChrome',
      focusable: 'false',
...
GoogleChrome.defaultProps = { height: 24, width: 24}
