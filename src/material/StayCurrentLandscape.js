...
const StayCurrentLandscape = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="StayCurrentLandscape-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-StayCurrentLandscape',
      focusable: 'false',
...
StayCurrentLandscape.defaultProps = { height: 24, width: 24}
