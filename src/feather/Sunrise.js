...
,
<line x1={12} x2={12} y1={2} y2={9} key="k1" />
,
...
,
<polyline points="8 6 12 2 16 6" key="k7" />
]


const Sunrise = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="Sunrise-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-Sunrise',
      focusable: 'false',
...
Sunrise.defaultProps = { height: 24, width: 24}
