...
const PermDataSetting = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="PermDataSetting-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-PermDataSetting',
      focusable: 'false',
...
PermDataSetting.defaultProps = { height: 24, width: 24}
