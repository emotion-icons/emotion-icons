...
const AppleMusic = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="AppleMusic-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-AppleMusic',
      focusable: 'false',
...
AppleMusic.defaultProps = { height: 24, width: 24}
