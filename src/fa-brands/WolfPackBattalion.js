...
const WolfPackBattalion = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="WolfPackBattalion-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 456 512',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-WolfPackBattalion',
      focusable: 'false',
...
WolfPackBattalion.defaultProps = { height: undefined, width: undefined}
