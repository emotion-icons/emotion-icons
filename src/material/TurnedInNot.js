...
const TurnedInNot = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="TurnedInNot-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-TurnedInNot',
      focusable: 'false',
...
TurnedInNot.defaultProps = { height: 24, width: 24}
