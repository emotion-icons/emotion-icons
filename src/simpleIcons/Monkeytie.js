...
const Monkeytie = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="Monkeytie-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-Monkeytie',
      focusable: 'false',
...
Monkeytie.defaultProps = { height: 24, width: 24}
