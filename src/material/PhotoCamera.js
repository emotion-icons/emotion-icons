...
const PhotoCamera = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="PhotoCamera-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-PhotoCamera',
      focusable: 'false',
...
PhotoCamera.defaultProps = { height: 24, width: 24}
