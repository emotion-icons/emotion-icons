...
const FilterTiltShift = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="FilterTiltShift-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-FilterTiltShift',
      focusable: 'false',
...
FilterTiltShift.defaultProps = { height: 24, width: 24}
