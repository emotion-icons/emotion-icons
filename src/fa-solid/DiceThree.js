...
const DiceThree = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="DiceThree-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 448 512',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-DiceThree',
      focusable: 'false',
...
DiceThree.defaultProps = { height: undefined, width: undefined}
