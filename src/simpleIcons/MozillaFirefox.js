...
const MozillaFirefox = ({ title, ...restProps }) => {
  return React.createElement(
    ...
    ),
    {
      children: (
        title
          ? [<title key="MozillaFirefox-title">{title}</title>, ...innerElements]
          : innerElements
      ),
      viewBox: '0 0 24 24',
       'aria-hidden': title ? null : 'true',
       'aria-labelledby': title && 'icon-title-MozillaFirefox',
      focusable: 'false',
...
MozillaFirefox.defaultProps = { height: 24, width: 24}
